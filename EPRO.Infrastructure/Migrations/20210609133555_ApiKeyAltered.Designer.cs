...
namespace EPRO.Infrastructure.Migrations
{
    ...
    [Migration("20210609133555_ApiKeyAltered")]
    partial class ApiKeyAltered
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EPRO.Infrastructure.Data.Models.Common.Dismissal", b =>
                {
                    ...
                    b.Property<string>("EditMotives")
                        .HasColumnName("edit_motives")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("EPRO.Infrastructure.Data.Models.Nomenclatures.ApealRegion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
            ...
            modelBuilder.Entity("EPRO.Infrastructure.Data.Models.Nomenclatures.Court", b =>
                {
                    ...
                    b.HasIndex("ApealRegionId")
                        .HasName("ix_nom_court_apeal_region_id");
            ...
            modelBuilder.Entity("EPRO.Infrastructure.Data.Models.Common.ApiKey", b =>
                {
                    b.HasOne("EPRO.Infrastructure.Data.Models.Nomenclatures.Court", "Court")
                        ...
                        .HasConstraintName("fk_api_keys_nom_court_court_id")
            ...
            modelBuilder.Entity("EPRO.Infrastructure.Data.Models.Nomenclatures.Court", b =>
                {
                    b.HasOne("EPRO.Infrastructure.Data.Models.Nomenclatures.ApealRegion", "ApealRegion")
                        .WithMany()
                        .HasForeignKey("ApealRegionId")
                        .HasConstraintName("fk_nom_court_nom_apeal_region_apeal_region_id");
                });
